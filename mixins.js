 ...
 */
function passwordStrength( value, criteria ){
    var _criteria
...
function isDefinedString( value ){
    return ! _.isNil( value ) && isDefinedType( 'string', value )
}
...
function isDefinedFunction( value ){
    return ! _.isNil( value ) && isDefinedType( 'function', value )
}
...
function isDefinedNumber( value ){
    return ! _.isNil( value ) && isDefinedType( 'number', value )
}
...
function isDefinedDate( value, parse ){
    ...
    if ( isDefinedType( 'date', value ) ) return true
...
function isDefinedMap( value ){
    return ! _.isNil( value ) && isDefinedType( 'map', value )
}
...
function isDefinedBoolean( value ){
    return ! _.isNil( value ) && isDefinedType( 'boolean', value )
}
...
function isDefinedArray( value ){
    return ! _.isNil( value ) && isDefinedType( 'array', value )
}
...
function isDefinedObject( value ){
    return ! _.isNil( value ) && isDefinedType( 'object', value )
}
...
function isDefinedPlainObject( value ){
    return ! _.isNil( value ) && isDefinedType( 'PlainObject', value )
}
